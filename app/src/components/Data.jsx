...
function Data () {
  ...
  async function fetchCoachData (requestBody) {
  ...
  async function fetchUserData (requestBody) {
      ...
      <div className='gridOptionsTable'>
        <div className='formOptions'>
          ...
          <div className='formOptionsSelection'>
            {selectedForms && selectedForms.map((forms) => (
              <table className='formOptionsNameTable' key={forms.id}>
                ...
                {forms.columns && forms.columns.map((column) => (
